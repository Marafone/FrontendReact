...
export const translations: TranslationsType = {
    ...
    PL: {
        home: {
            ...
            joinGameBtn: "Dołącz do gry znajomego",
    ...
    IT: {
        home: {
            ...
            joinGameBtn: "Unisciti alla partita di un amico",
            newsTitle: "Notizie",
            newsContent:
    ...
    RGN: {
        home: {
            ...
            joinGameBtn: "Intra in zòca dal to amîg",
            newsTitle: "Notìzi",
            newsContent:
